...
const Prism: React.FC<PrismProps> = ({
    ...
    useEffect(() => {
        ...
        // Safety: Clear color to transparent
        gl.clearColor(0, 0, 0, 0);

        // FIX: Enable blending for transparency to work correctly with the background
        gl.enable(gl.BLEND);
        gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);

        // We don't need depth for a fullscreen shader usually, but doesn't hurt to disable
    ...
    `;
        ...
        const program = new Program(gl, {
            ...
            transparent: transparent // Pass transparent flag to program
        });
        ...
        const resize = () => {
            ...
            // Explicitly update uniform values to ensure OGL picks up changes
            program.uniforms.iResolution.value = iResBuf;
